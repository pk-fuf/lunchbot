...
with requests.Session() as s:
  ...
  napoliMonday = str(napoliFull[4].text).splitlines()[1].replace('\t', '').replace('€', '')
  napoliTuesday = str(napoliFull[11].text).splitlines()[1].replace('\t', '').replace('€', '')
  napoliWednesday = str(napoliFull[18].text).splitlines()[1].replace('\t', '').replace('€', '')
  napoliThursday = str(napoliFull[25].text).splitlines()[1].replace('\t', '').replace('€', '')
  napoliFriday = str(napoliFull[32].text).splitlines()[1].replace('\t', '').replace('€', '')
  napoliToday = ''
  if toDay == 'Monday':
    napoliToday = "\n:napoli: " + napoliMonday
  elif toDay == 'Tuesday':
